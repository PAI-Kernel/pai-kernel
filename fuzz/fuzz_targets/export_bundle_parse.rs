...
// deserialization + integrity-verification path for adopter-provided bundles
// (i.e. someone attempting to import a compromised OR malformed PAI-Kernel
// governance bundle).
...
fuzz_target!(|data: &[u8]| {
    // Try to deserialize a bundle from arbitrary fuzzer-provided bytes.

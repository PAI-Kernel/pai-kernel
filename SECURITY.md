...
Email `contact@paikernel.org` with `[SECURITY]` in subject line.
...
Runtime security controls (cargo audit, CodeQL, SPARK formal
verification, TLA+ model checking, OPA/Rego policy enforcement)
are maintained in the internal development repository and verified
